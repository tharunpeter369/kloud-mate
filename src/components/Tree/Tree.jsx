            ...
            <TreeItem key={nodes.id} nodeId={nodes.id}
                ...
                label={
                    <Box display="flex" alignItems="center" backgroundColor="" >
                        ...
                        <Box position="fixed" left="3.5vw" width="76vw" height={{}} marginLeft={31} backgroundColor="" >
                            <Box>
                                <Box padding={1} marginLeft={position}>
                                    <BorderLinearProgress variant="determinate" value={width} customcolor="rgb(255, 149, 31)" />
                                </Box>
                            </Box>
                        </Box>
                    </Box>
    ...
    return (
        ...
        >
            <Box sx={{ marginTop: "10px" }}>
                <Box position="absolute" left="3.5vw" width="76vw" height="100%" marginLeft={31} backgroundColor="" zIndex={1000} >
